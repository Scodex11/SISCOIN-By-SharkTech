				...
				<ul id="accordion-menu">
					<li class="dropdown">
						<a href="view_index_informatica.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span><span class="mtext">COMPRAS</span>
						</a>
					</li>
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="#">Listado Licitaciones</a></li>
						</ul>
						<ul class="submenu">
							<li><a href="#">Equipamiento Total</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-name"></span><span class="mtext">Proveedores</span>
						</a>
						<ul class="submenu">
